...
//    }
    ...
    /**
     * Test of transfrer method, of class CompteService.
     */
    @Test
    public void testTransfrer() {
        System.out.println("transfrer");
        String ribSource = "EE1";
       String ribDestination = "EE2";
        double montant = 3;
        CompteService instance = new CompteService();
        int expResult = 1;
        int result = instance.transfrer(ribSource, ribDestination, montant);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
   }
